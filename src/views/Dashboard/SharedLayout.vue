       ...
       <router-link to="/admin">
        ...
        <nav class="p-6 w-full flex flex-col">
            <ul class="space-y-1.5">
                <router-link :to="{ name: 'gen' }"
                    class="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-md text-white rounded-lg"
                    active-class="border ">
                ...
                <router-link :to="{ name: 'corr' }"
                    class="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-md rounded-lg text-white "
                    active-class="border ">
                ...
                <router-link :to="{ name: 'marks' }"
                    class="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-md rounded-lg text-white "
                    active-class="border ">
                    <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M11 5h4M7 10h10m-9 5h8">
                        </path>
                    </svg>
                    <li>Exam Marks</li>
                </router-link>
                <router-link v-if="user.is_superuser" :to="{ name: 'users' }"
                    class="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-md rounded-lg text-white "
                    active-class="border">
                    <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
